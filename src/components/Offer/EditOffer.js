...
const EditOffer = ({ id, onClose, onUpdate }) => {
    ...
    //         await axios.post(`https://riseuplabs-ecommerce-backend.onrender.com/posts/update/${id}`, formData, {
    //             headers: {
    //                 'Authorization': `Bearer ${token}`,
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Send the request to update the post
            await axios.post(`https://riseuplabs-ecommerce-backend.onrender.com/home/update/${id}`, formData, {
                headers: {
                    'Authorization': `Bearer ${token}`,
